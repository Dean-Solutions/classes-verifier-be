...
//
//        List<EnrollmentRO> result = enrollmentService.getEnrolledSubjectsByUserId(enrollForUserDTO);
//
...
//        when(studentService.getRawUserById(userId)).thenReturn(userEntity);
//        when(semesterService.getSemesterById(semesterId)).thenReturn(semester);
//        when(enrollmentRepository.findAllByEnrollStudentAndSemesterAndEnrollStatusIsIn(userEntity, semester, enrollStatuses)).thenReturn(expectedEnrollments);
//
//        List<EnrollmentRO> actualEnrollments = enrollmentService.getEnrolledSubjectsByUserId(enrollForUserDTO);
//
//        verify(studentService, times(1)).getRawUserById(userId);
//        verify(semesterService, times(1)).getSemesterById(semesterId);
...
//
//        List<EnrollmentRO> updatedEnrollments = enrollmentService.acceptEnrollments(enrollmentIds);
//
//        for (EnrollmentRO enrollment : updatedEnrollments) {
